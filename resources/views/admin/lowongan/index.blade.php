...
<head>
    ...
    <title>Daftar Lowongan - PerpusLab Nusantara</title>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                        ...
                                                        data-bs-target="#editlwnModal{{ $lwn->id }}">Edit</button>
                                                    <form
                                                        action="{{ route('admin.lowongan.destroy', ['id' => $lwn->id]) }}"
                                                ...
                                                <!-- Modal -->
                                                <div class="modal fade" id="editlwnModal{{ $lwn->id }}"
                                                    tabindex="-1" aria-labelledby="editlwnModalLabel"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="form form-vertical" id="editlwnForm"
                                                                method="post"
                                                                action="{{ route('admin.lowongan.update', ['id' => $lwn->id]) }}"
                                                                enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="editlwnModalLabel">
                                                                        Edit lwn</h5>
                                                                    ...
                                                                    <div class="form-body">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="nama_lowongan"
                                                                                        value="{{ $lwn->nama }}"
                                                                                        placeholder="Nama lowonngan">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="nama_lowongan">Gaji</label>
                                                                                    <input type="text"
                                                                                        id="nama_lowongan"
                                                                                        class="form-control"
                                                                                        value="{{ $lwn->gaji }}"
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="perusahaan">Perusahaan</label>
                                                                                    <input type="text"
                                                                                        id="perusahaan"
                                                                                        class="form-control"
                                                                                        value="{{ $lwn->perusahaan }}"
                                                                                        name="perusahaan"
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select id="jenis"
                                                                                        ...
                                                                                        name="jenis">
                                                                                        <option value="1"
                                                                                            {{ $lwn->jenis == 1 ? 'selected' : '' }}>
                                                                                            Full Time
                                                                                        </option>
                                                                                        <option value="2"
                                                                                            {{ $lwn->jenis == 2 ? 'selected' : '' }}>
                                                                                            Part Time
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select id="status"
                                                                                        ...
                                                                                        name="status">
                                                                                        <option value="1"
                                                                                            {{ $lwn->status == 1 ? 'selected' : '' }}>
                                                                                            Tersedia
                                                                                        </option>
                                                                                        <option value="2"
                                                                                            {{ $lwn->status == 2 ? 'selected' : '' }}>
                                                                                            Terbatas
                                                                                        </option>
                                                                                        <option value="3"
                                                                                            {{ $lwn->status == 3 ? 'selected' : '' }}>
                                                                                            Terpenuhi
                                                                                        </option>
                                                                                    </select>
                                                                                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form class="form form-vertical" id="lowonganForm" method="post"
                                action="{{ route('admin.lowongan.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="lowonganModalLabel">Tambah Lowongan Baru</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="nama_lowongan">Gaji</label>
                                                    <input type="text" id="nama_lowongan" class="form-control"
                                                        name="gaji" placeholder="Range gaji per tahun">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="kategori" class="form-control"
                                                        name="kategori" placeholder="cth: Teknologi Informasi">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
